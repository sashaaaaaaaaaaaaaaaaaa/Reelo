...
import NavbarItem from '@/components/NavbarItem'; // Adjust the path as needed
import MobileMenu from '@/components/MobileMenu';
import AccountMenu from '@/components/AccountMenu';
import VintageSearch from '@/components/VintageSearch'; // Adjust the path as needed
    ...
    return (
        <nav className="w-full fixed z-40 m-0 p-0">
            ...
            >
                ...
                <div className="flex-grow mx-auto text-gray-200 hover:text-blue-200 cursor-pointer transition w-10 lg:w-auto">
                    <VintageSearch />
                </div>
                ...
                <div className="flex items-center gap-7">
                    ...
                    <div className="hidden lg:flex items-center ml-4 gap-7">
                        <NavbarItem to="/" label="Discover" />
                        <NavbarItem to="/Vintage" label="Vintage" />
                        <NavbarItem to="/favlist2" label="Must-Watchlist" />
